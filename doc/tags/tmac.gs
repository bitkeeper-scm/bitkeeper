...
.nf
.rs
.\" LMXXX - removed, I don't like this down so far.
.\" .sp 3
.ce 9999
.cov*tl-div
.nr cov*i 1
...
.\" LMXXX - fix for variable PS.
.ne 3v+\\n[\\n[.ev]:PD]u+\\n(.Vu
.\" LMXXX - removed because of headers.
.\" .sp 1
.ft B
..
...
.\}
.SH
.\" XXX - this should figure out if there has been any text between 
.\" headings and adjust the space accordingly.
.if \\n[VARPS]=1 \{\
.	if \\n[nh*hl]=0 \{\
.		sp 1
.		ps (\\n[PS]+\\n[VARBASE]+2)
...
.\" Larry McVoy's hacks start here
.\" HLINE - horizontal line
.\"    - works in 1 or 2 column mode
.de HLINE
.br
\fB\s(36\\l'\\n[pg@colw]u'\fP\s0
.br
..
.\" LGRAY - like .LP but with a gray box under it.  See .LEND
.de LGRAY
.	LP
.	nr y 8.5i
.	nr x \\n[.l]u
.	br
\\X'ps: exec gsave \\nx u 0 rlineto 0 \\ny u rlineto -\\nx u 0 rlineto closepath .899 setgray fill grestore'
.	br
.	nr INLG 1
..
.
.\" LEND - must be called after .LGRAY to finish things up.
.de LEND
.	if \\n[INLG]=1 \{\
.		br
.		nr y 8.5i
.		nr x \\n[.l]u
.		br
\\X'ps: exec gsave \\nx u 0 rlineto 0 \\ny u rlineto -\\nx u 0 rlineto closepath 1 setgray fill grestore'
.		br
.		nr INLG 0
.	\}
..
.\" HSTART - start a floating display set off by horizontal lines
.de HSTART
.	HLINE
.	DS L
..
.\" HEND - end of .HSTART request
.de HEND
.	DE
.	sp -.75
.	HLINE
