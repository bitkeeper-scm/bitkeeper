...
MODULE_SCOPE void *TclBNRealloc(void *, size_t, size_t);
MODULE_SCOPE void *TclBNCalloc(size_t, size_t);
MODULE_SCOPE void  TclBNFree(void *, size_t);

#define MP_MALLOC TclBNAlloc
#define MP_REALLOC TclBNRealloc
#define MP_CALLOC TclBNCalloc
#define MP_FREE TclBNFree

#define XMALLOC(x) TclBNAlloc(x)
#define XFREE(x) TclBNFree((x), 0)
#define XREALLOC(x,n) TclBNRealloc((x), 0, (n))
