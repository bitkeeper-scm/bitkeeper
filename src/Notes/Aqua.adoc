...
Tear-off menus were removed in Aqua where possible and dissabled 
where not.
...
- There is a bad interaction with what Mac OS X deffines as "an application"
  ...
  be hosed because it's not responging to GUI events) until the user dismisses
