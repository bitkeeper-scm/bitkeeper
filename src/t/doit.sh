...
setup_env()
{
	...
	BK_LIC_P=BKL53f52d2503d719ed00001200ffffe
     BK_LIC_P1=YgAAAo0AAAADgAAAAIVXjsh1IgrXVK3W3flMk90O69C3uctMdgkeDmcZzFqVqnti
     BK_LIC_P2=325jcP8Flq4o9n7RguQZEWMmAxpl+kWV8c57uOxBXzzghi5GpPL4BzR+1AZLWsXz
     BK_LIC_P3=EHX+DR2nhQt06pATX47EA5Wh37+vtxIiHYZhs5YTcTJpSD3xKvV9vbiGpDMq
	BK_LIC_B=BKL53f52d2503d719ed00001100ffffe
     BK_LIC_B1=YgAAAo4AAAADgQAAAAFh6k0m5PVc4sDTeRu+SHHlRYu/J/S1JQC1uOWZ2d5W/uWF
     BK_LIC_B2=q+HaT/OgbdCyjQ0vTY65SVvgDml4U2q9yp3dxDJ58MZCarZiIyBcnFnxSddc2jeW
     BK_LIC_B3=N9x7KzPDZelK6EAgbEc9/TzJQOtPLQ7burrdqTGdA4lF3CPu56G73iP3jIp4yw==
}
...
init_main_loop()
{
	...
	export BK_LIC_P1 BK_LIC_P2 BK_LIC_P3
	export BK_LIC_B1 BK_LIC_B2 BK_LIC_B3
}
