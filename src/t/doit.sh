...
setup_env()
{
	...
	BKL_PRO=BKL651315d8a368c808000012fdfffff42e572b43
	BKL_P1=YgAAAo4AAAADgQAAAALJxHdIV5aCo7yMtXz82syaLCUgz+iF1//wx4aQB6LrpGIH
	BKL_P2=zqyovwmN+UuuP2bftrLAlOCqsJdJlDGei5UAiwY1Ukg2zBLyRTjnprnSG1AFrETj
	BKL_P3=i/E8f8+WXLsYK7GHIH2pVnlwnuaItlfE90umtWH/63QeLd8bH46wNWiheWMXfg==

	# Valid pro p --airgap --bkweb --bugdb --import --eula=pro
	BKL_pro=BKL651315d8b368c8080000121dfffff42e572b43
	BKL_p1=YgAAAo4AAAADgQAAAAFNDqXv4n69RRWMlrEb/vtANl3nOANKWSp/y0mO/r9b2+NG
	BKL_p2=bbgRBTLG0vvZiiir66d4M331DxCC8EogvmzNayslax/svzvQO0Jj1+3/4ISuNyI8
	BKL_p3=5gWO0y4//0+FtmLhz4dcVye5WGBS+pzc1sDl8LvbGoqY2WRxejXGx9w18NUtPA==

	# Valid ENTERPRISE E --airgap --eula=enterprise
	BKL_ENTERPRISE=BKL651315d8c368c8080000121cfffff42e572b44
	BKL_E1=YgAAAo4AAAADgQAAAACxAJFURmOwTYaDyqDH8TZakwdqNu+kL11JTrKPBFNLpYkD
	BKL_E2=0fAxuyvvG8j6/ogsA73Zjk7e6woGGiJjYfZRk9N1TsK21lHg9rauv8RNjeBXIR84
	BKL_E3=vrhceFwQSrrznVerieCSOLy6OECJOhPOoT5ItVB+/sbsdw93WLnz/2KiPSo8fA==

	# Valid MLA M --airgap --eula=mla
	BKL_MLA=BKL651315d8c368c8080000121cfffff42e572b45
	BKL_M1=YgAAAo4AAAADgQAAAAG7jIJd2E0AW4ugppPEmYLGoR4MEXLFhCjwA8qVKpzVjHEg
	BKL_M2=ItC9R0SdE/PzAVeZ8D1RKIml+ezsI5uvfaKe4KPAynj/C1Vvja5UYiJBzGv/lZZE
	BKL_M3=FF97PIZstc+8EjSv3qX19qV8JdW+v8SjsRfgObLIDeU+Fw+EeFr0OSxIis/gqA==
	...
	BKL_7=BKL751315d8d368c8080000121dfffff42e572b43
	BKL_71=YgAAAo4AAAADgQAAAAFrq2hwUDVVdeg5F1PZC7sK2chxNXYWaI/B9rquODROeYyC
	BKL_72=RpB8zE9eicWGLsDGFEFB1auQlozB9N0i2tA6R12tGreTUO3rIo6uhzWk0wz2L1jm
	BKL_73=50iw79mT+us+8ADwQ1NvB1cavmwchfbCDyC/dO+DckCCywPPFisvaCFGleL0Gw==
