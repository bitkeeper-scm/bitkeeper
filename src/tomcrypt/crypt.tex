...
\makeindex
\begin{document}
\title{Tiny Crypto Library \\ ``LibTomCrypt'' \\ Version 0.66}
\author{Tom St Denis \\
Algonquin College \\
\\
...
the length of the message digest back in it.  The functions are otherwise straightforward.  To perform the above 
