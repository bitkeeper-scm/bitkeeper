...
\makeindex
\begin{document}
\title{A Tiny Crypto Library, \\ LibTomCrypt \\ Version 0.72}
\author{Tom St Denis \\
Algonquin College \\
\\
...
int main(void)
{
   ...
   if (register_cipher(&twofish_desc) == -1) {
      printf("Error registering Twofish.\n");
      return -1;
   }
...
PRNG  you can pass ``prng\_find(`sprng')'' as the index and NULL as the prng state.  
